...
(function (root) {
  ...
  function bind() {
    document.addEventListener("click", function (ev) {
      ...
      if (a.dataset.act === "pdf") {
        var msg = el("submitMsg");
        if (msg) msg.textContent = "Building the PDF…";
        root.ReportDoc.download(blocks(), {
          ...
          .then(function () { if (msg) msg.textContent = "PDF downloaded."; })
          .catch(function () { if (msg) msg.textContent = "The PDF could not be built — try the print button."; });
      }
